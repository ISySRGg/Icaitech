...
export const submissionGuidelines: Guideline[] = [
  ...
  "**All papers should meet the [IEEE template](https://www.ieee.org/conferences/publishing/templates)** and the committee reserves the right not to accept and not to proceed with any papers that do not meet this template.",
  ...
  "**Make sure** the length of your paper is between 4 – 6 pages",
  ...
  "The final paper **MUST be pdf file** which converted using PDF eXpress, the guideline is below",
]