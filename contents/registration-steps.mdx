We After you transfer **according to the nominal amount** on the invoice, **send proof of payment** in the following registration [Form](https://forms.gle/bVbfqjcGE41vhzwbA) (Form submission needs to log in from a Google account)
