We After you transfer **according to the nominal amount** on the invoice, **send proof of payment** in the following registration [Form](https://bit.ly/icaitech2025-registration) (Form submission needs to log in from a Google account)
...
- Make sure one of the author(s) of the paper registers for the conference before November 10, 2025. Please fill in the following form (Form submission needs to log in from a Google account)
